...
class RPCClient extends EventEmitter {
  ...
  async PLAY_SOUNDBOARD_SOUND(params) {
    const res = await this.request(RPCCommands.PLAY_SOUNDBOARD_SOUND, params);
    return res;
  }

  async GET_SOUNDBOARD_SOUNDS() {
    const res = await this.request(RPCCommands.GET_SOUNDBOARD_SOUNDS);
    return res;
  }

  async GET_SELECTED_VOICE_CHANNEL() {
    const res = await this.request(RPCCommands.GET_SELECTED_VOICE_CHANNEL);
    return res;
  }
